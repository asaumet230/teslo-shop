...
import { Box, Button, capitalize, Card, CardActions, CardMedia, Checkbox, Chip, Divider, FormControl, FormControlLabel, FormGroup, FormLabel, Grid, ListItem, Paper, Radio, RadioGroup, TextField, Input } from '@mui/material';
...
const ProductAdminPage: FC<Props> = ({ product }) => {
    ...
    const onFileSelected = async ({ target }: ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            for (const file of target.files) {
                ...
                setValue('images', [...getValues('images'), data.imagePath], { shouldValidate: true });
            }
    ...
    const onSubmit = async (form: FormData) => {
        ...
        if (form.images.length < 2) return alert('Minimo son 2 imagenes');
        setIsSaving(true);
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} sm={6}>
                        ...
                        <TextField
                            ...
                            {...register('inStock', {
                                required: 'Este campo es requerido',
                                min: { value: 0, message: 'Valor mínimo es cero' }
                            })}
